...
// Empty form config for OIDC full mode: keeps the card shell, hides inputs/buttons/links
const ssoOnlyFormConfig: IFormBoxConfig = {
	title: '',
	buttonText: '',
	redirectText: '',
	redirectLink: '',
...
<template>
	<div>
		<AuthView
			v-if="!showMfaView"
			:form="isCommunityOidcFullMode ? ssoOnlyFormConfig : formConfig"
